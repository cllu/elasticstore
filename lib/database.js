...
Database.prototype.registerType = function (Type, context) {
  ...
  // helper functions
  //Type.createInstance = Type.prototype.createInstance.bind(Type);
  //Type.addHook = Type.prototype.addHook.bind(Type);
  //Type.executeHooks = Type.prototype.executeHooks.bind(Type);
  //Type.getStoreClient = Type.prototype.getStoreClient.bind(Type);
  //Type.getIndex = Type.prototype.getIndex.bind(Type);
  //Type.getType = Type.prototype.getType.bind(Type);
  //Type.getStore = Type.prototype.getStore.bind(Type);
  //Type.getContext = Type.prototype.getContext.bind(Type);
  //
  //
  ...
  //Type.findAll = Type.prototype.findAll.bind(Type);
  //Type.findById = Type.prototype.findById.bind(Type);
  //Type.findOne = Type.prototype.findOne.bind(Type);
