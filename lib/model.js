...
Model.prototype.get = function (id, callback) {
  var self = this;
  return self._database.client.get({
...
Model.prototype._saveOne = function (data_, callback) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    resolve(data);
      ...
      return self._database.client.index({
        index: self._database._es_index,
        type: self._es_doc_type,
        id: data._id,
        body: data,
...
Model.prototype.save = function (data, callback) {
  if (isArray(data)) {
    ...
    return Promise.map(data, function (item) {
      ...
      return self._database.client.indices.refresh({
        index: self._database._es_index
      }).then(function() {
        return docs;
      });
...
Model.prototype.updateById = function (id, update, callback) {
  ...
  return self.get(id)
    ...
    .then(function () {
      return self._database.client.update({
...
Model.prototype.drop = function (callback) {
  ...
  return self._database.client.deleteByQuery({
    index: self._database._es_index,
    type: self._es_doc_type,
    body: {
      query: {
...
Model.prototype.count = function (callback) {
  var self = this;
  return this._database.client.count({
    index: self._database._es_index,
    type: self._es_doc_type
  }).then(function (resp) {
    return resp.count;
...
Model.prototype.find = function (filter, options, callback) {
  ...
  return self._database.client.search({
    index: self._database._es_index,
    type: self._es_doc_type,
    body: {
      query: query
...
Model.prototype.deleteMapping = function (callback) {
  var self = this;
  return self._database.client.indices.deleteMapping({
    index: self._database._es_index,
    type: self._es_doc_type
  }).catch(function (err) {
