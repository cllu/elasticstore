 ...
 *   @param {Number} [options.version] Store version
 *   @param {String} [options.host] ElasticSearch host, such as localhost:9200
 *   @param {String} [options.name] ElasticSearch index name
 *   @param {Object} [options.mapping]
 *   @param {Function} [options.onUpgrade]
 *   @param {Function} [options.onDowngrade]
 * @constructor
 * @module warehouse
 */
 ...
 * @returns {*}
 */
Store.prototype.registerType = function (Type, context) {
 ...
 * Drop all mappings
 */
Store.prototype.dropMappings = function () {
